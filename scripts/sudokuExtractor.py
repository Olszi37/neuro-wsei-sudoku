...
class Extractor(object):
    ...
    def preprocess(self):
        print 'Preprocessing...',
        # przemiana obrazu do skali szarosci, thresholding adaptacyjny, uzupelnienie brakow z szumow
    ...
    def straighten(self, sudoku):
        ...
        # wyprostowanie krzywej badz nierownej siatki sudoku
